...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { brand: @pin.brand, comment: @pin.comment, title_Of_Piece: @pin.title_Of_Piece }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { brand: @pin.brand, comment: @pin.comment, title_Of_Piece: @pin.title_Of_Piece }
    assert_redirected_to pin_path(assigns(:pin))
  end
