Layprophet::Application.routes.draw do
  resources :pins
  ...
  get "reka" => "pages#reka"
  get "ludo" => "pages#ludo"
  get "herakut" => "pages#herakut"
  get "claudioethos" => "pages#claudioethos"
  get "dface" => "pages#dface"
  get "pandilla" => "pages#pandilla"
  get "mobstr" => "pages#mobstr"
  get "daleast" => "pages#daleast"
  get "clarionalley" => "pages#clarionalley"
  get "socialpiece" => "pages#socialpiece"
